//#region node_modules/bitecs/dist/core/index.min.mjs
var A = (e, t, n) => Object.defineProperty(e, t, {
	value: n,
	enumerable: !1,
	writable: !0,
	configurable: !0
...
var z = (e) => {
	let t = e ? typeof e == "function" ? e() : e : {
		versioning: !1,
		versionBits: 8
	}, n = t.versionBits ?? 8, o = t.versioning ?? !1, r = 32 - n, a = (1 << r) - 1, i = r;
	return {
		aliveCount: 0,
		dense: [],
		sparse: [],
...
var Y = () => {
	let e = {
		...
		if (!e.pairsMap.has(o)) {
			...
			A(r, k, t), A(r, T, o), A(r, U, !0), e.pairsMap.set(o, r);
		}
...
var le = (e) => {
	let t = e[x];
	return t.exclusiveRelation = !0, e;
};
var he = (e) => {
	let t = e[x];
	return t.autoRemoveSubject = !0, e;
};
var be = (e) => (t) => {
	let n = t[x];
...
function ot(...e) {
	if (e.length === 1 && typeof e[0] == "object") {
		...
		return [
			...
			o && he,
			r && be(r)
		].filter(Boolean).reduce((i, s) => s(i), Y());
	} else return e.reduce((n, o) => o(n), Y());
}
var Re = Symbol.for("bitecs-wildcard");
function rt() {
	let e = Y();
	return Object.defineProperty(e, Re, {
		value: !0,
		enumerable: !1,
		writable: !1,
		configurable: !1
...
var B = it();
function ct(e) {
	return e ? Object.getOwnPropertySymbols(e).includes(Re) : !1;
}
function xe(e) {
	return e ? Object.getOwnPropertySymbols(e).includes(x) : !1;
}
var pt = 64;
var g = 4294967295;
var ge = 1024;
...
function oe(e, t) {
	...
	if (!n.hierarchyData.has(t)) {
		...
		r.fill(g), n.hierarchyData.set(t, {
			depths: r,
			dirty: M(),
...
function De(e, t) {
	...
	if (r.dense.length !== 0) {
		for (let i of r.dense) if (a[i] === g) ne(o, i, Ie(e, t, i));
		r.reset();
	}
}
function Oe(e, t, n, o = {}) {
	...
	De(e, t), re(e, n, o);
	let s = r.queriesHashMap.get(H(e, n)), { depths: c } = r.hierarchyData.get(t);
	s.sort((d, W) => {
		let l = c[d], R = c[W];
		return l !== R ? l - R : d - W;
	});
	let f = (o.buffered, s.dense);
	return r.hierarchyQueryCache.set(t, {
		hash: a,
		result: f
	}), f;
}
function Qe(e, t, n, o = {}) {
	...
	return a ? (o.buffered, a.dense) : o.buffered ? /* @__PURE__ */ new Uint32Array(0) : [];
}
function dt(e, t, n) {
...
var ee = (e, t, n = {}) => {
	...
	let d = a.map((m) => o.componentMap.get(m)), W = [...new Set(d.map((m) => m.generationId))], l = (m, h) => (m[h.generationId] = (m[h.generationId] || 0) | h.bitflag, m), R = s.map((m) => o.componentMap.get(m)).reduce(l, {}), _e = p.map((m) => o.componentMap.get(m)).reduce(l, {}), Ge = c.map((m) => o.componentMap.get(m)).reduce(l, {}), ze = d.reduce(l, {}), Q = Object.assign(n.buffered ? X() : M(), {
		allComponents: a,
		orComponents: c,
		notComponents: p,
		masks: R,
...
function re(e, t, n = {}) {
	...
	return a ? n.buffered && !("buffer" in a.dense) && (a = ee(e, t, { buffered: !0 })) : a = ee(e, t, n), n.buffered, a.dense;
}
function $(e, t, ...n) {
	let o = t.find((p) => p && typeof p == "object" && ae in p), r = t.filter((p) => !(p && typeof p == "object" && ae in p)), a = !1, i = !0, s = n.some((p) => p && typeof p == "object" && F in p);
	for (let p of n) if (s && p && typeof p == "object" && F in p) {
		let c = p;
		c[F] === "buffer" && (a = !0), c[F] === "nested" && (i = !1);
	} else if (!s) {
		let c = p;
...
var E = (e, t) => {
	...
	let n = e[u], o = /* @__PURE__ */ new Set(), r = {
		id: n.componentCount++,
...
var j = (e, t, n) => {
	...
	if (O(e, t, r)) return a !== void 0 && i.setObservable.notify(t, a), !1;
	...
	if (o.entityMasks[s][t] |= p, O(e, t, q) || c.forEach((f) => {
		...
		let f = r[k], d = r[T];
		if (G(e, t, b(f, y), b(y, d)), typeof d == "number" && (G(e, d, b(y, t), b(y, f)), o.entitiesWithRelations.add(d), o.entitiesWithRelations.add(t)), o.entitiesWithRelations.add(d), f[x].exclusiveRelation === !0 && d !== y) {
			let l = I(e, t, f)[0];
...
var C = (e, t, ...n) => {
	...
	n.forEach((r) => {
		if (!O(e, t, r)) return;
		let { generationId: i, bitflag: s, queries: p } = o.componentMap.get(r);
